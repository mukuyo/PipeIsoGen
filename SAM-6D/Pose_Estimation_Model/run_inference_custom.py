...
def get_parser():
    ...
    parser.add_argument("--det_score_thresh", default=0.6, help="The score threshold of detection")
    parser.add_argument('--obj_name', default="templates", help="The name of target object")
